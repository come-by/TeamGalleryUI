export enum ErrorCode {
  ...
  PROJECT_MEMBER_INVITE_DISABLED = 'PROJECT_MEMBER_INVITE_DISABLED',
  PROJECT_MEMBER_BLOCKED = 'PROJECT_MEMBER_BLOCKED',
  PROJECT_MEMBER_USER_INACTIVE = 'PROJECT_MEMBER_USER_INACTIVE',
  PROJECT_MEMBER_EXISTS = 'PROJECT_MEMBER_EXISTS',
  REPLAY_NONCE_USED = 'REPLAY_NONCE_USED',
  REPLAY_TIMESTAMP_EXPIRED = 'REPLAY_TIMESTAMP_EXPIRED',
}
